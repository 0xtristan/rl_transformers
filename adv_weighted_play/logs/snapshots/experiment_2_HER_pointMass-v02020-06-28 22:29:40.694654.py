...
def setup(env_fn, ac_kwargs, seed, replay_size, lr, load, exp_name, render, strategy):
...
def training_loop(env_fn,  ac_kwargs=dict(), seed=0,
    ...
    env, test_env, model, replay_buffer, summary_writer = setup(env_fn, ac_kwargs, seed, replay_size, lr, load, exp_name, render, strategy)

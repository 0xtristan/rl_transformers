...
def setup(env_name, ac_kwargs, seed, replay_size, lr, load, exp_name, render, strategy):
    ...
    return env, test_env, model, replay_buffer, summary_writer


def training_loop(env_name,  ac_kwargs=dict(), seed=0,
    ...
    env, test_env, model, replay_buffer, summary_writer = setup(env_name, ac_kwargs, seed, replay_size, lr, load, exp_name, render, strategy)
